...
export default class Teacher extends Component {
    ...
    render() { 
       ...
       //  let {backGround} = this.props;
        return ( 
            <div className = "teacher" style = { {width: '100%', height: '100%', margin: 'auto'} }>
                    <Grid className = "teacher-grid">
                        <Cell col = {12}>
                            ...
                            <div className = "toggle"> <Toggle></Toggle> </div>
                            <div id  = "addclass" className = "add_class" style={{ display: "flex" }}>
                            <button>
                                Add Class
                            </button>
                            </div>
